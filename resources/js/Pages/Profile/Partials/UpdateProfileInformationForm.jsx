...
import { User, Weight, Save, CheckCircle2, Info, Bell } from "lucide-react";
...
export default function UpdateProfileInformation({ className = "" }) {
    ...
    const { data, setData, patch, errors, processing, recentlySuccessful } =
        useForm({
            ...
            height: user.height || "",
            weight: user.weight || "",
            is_reminder_on: !!user.is_reminder_on,
        });
                    ...
                    <div className="lg:col-span-5 bg-white p-8 rounded-[2.5rem] border border-gray-100 shadow-sm space-y-6">
                        ...
                        <div className="space-y-4">
                            <div>
                                ...
                                <TextInput
                                    id="name"
                                    className="w-full bg-gray-50/50 border-gray-100 mt-1"
                                    value={data.name}
                                    onChange={(e) =>
                            ...
                            <div className="pt-2">
                                <label className="flex items-center gap-3 cursor-pointer group">
                                    <div className="relative">
                                        ...
                                        />
                                        <div className="w-10 h-5 bg-gray-200 rounded-full peer peer-checked:bg-blue-600 transition-colors duration-200"></div>
                                        <div className="absolute left-1 top-1 bg-white w-3 h-3 rounded-full peer-checked:translate-x-5 transition-transform duration-200"></div>
                                    </div>
                ...
                <div className="bg-white px-8 py-4 rounded-3xl border border-gray-100 shadow-sm flex items-center justify-between">
                    <div className="flex items-center gap-2 text-gray-400">
                        ...
                        <p className="text-xs font-medium">
                            BMI is updated automatically upon save.
                        </p>
                    </div>
